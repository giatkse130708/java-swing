...
public class Main extends javax.swing.JFrame {
    ...
    private void btnNumberActionClicked(String s) {
        if(!operation.isEmpty() && !flagDisplay){
            txtDisplay.setText("");
            flagDisplay = true;
        } else if (!flagDisplay){ //for display M+, M-
            txtDisplay.setText("");
            flagDisplay = true;
        }
        txtDisplay.append(s);
        ...
        panelButtonLayout.setVerticalGroup(
            ...
            .addGroup(panelButtonLayout.createSequentialGroup()
                ...
                .addGroup(panelButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnBalance, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void btnMAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMAddActionPerformed
        ...
        MR += Double.parseDouble(txtDisplay.getText());
        flagDisplay = false;

...
public class Replace extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            ...
                            .addGap(31, 31, 31)
                            .addComponent(txtKey, javax.swing.GroupLayout.PREFERRED_SIZE, 312, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
    ...
    private void btnReplaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReplaceActionPerformed
        content = Main.txtTextArea.getText();
        String s = txtKey.getText();
        if (content.contains(s)) {
            index = content.indexOf(s);
            content = content.replaceFirst(content.substring(index, index + s.length()), txtReplace.getText());
            Main.txtTextArea.setText(content);
            Main.txtTextArea.select(index, index + txtReplace.getText().length());
        }else{
